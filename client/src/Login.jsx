...
const Login = () => {
  ...
  const handleMfaSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(errorMessage);
      // If MFA session expired, go back to login
        ...
        <div className="bg-[#111] border-2 border-[#facc15] shadow-[6px_6px_0px_0px_#facc15] px-8 py-8">
          ...
          {mfaStep ? (
            <>
              ...
              <form className="space-y-5" onSubmit={handleMfaSubmit}>
                <div>
                  ...
                  <input
                    ...
                    placeholder="000000"
                    maxLength={6}
                    className="block w-full px-4 py-4 bg-[#0a0a0a] border-2 border-white/20 text-white text-center text-3xl font-mono tracking-[0.5em] placeholder:text-white/20 focus:outline-none focus:border-emerald-500 focus:shadow-[4px_4px_0px_0px_rgba(16,185,129,0.5)] transition-all"
                  />
                </div>
                ...
                <div className="pt-2 space-y-3">
                  <button
                    ...
                    className={`w-full flex justify-center items-center gap-2 py-3 px-4 bg-emerald-500 text-black text-sm font-black uppercase tracking-wide border-2 border-black shadow-[4px_4px_0px_0px_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#000] transition-all duration-150 ${
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 bg-[#0a0a0a] text-white/50 text-sm font-bold uppercase tracking-wider border-2 border-white/10 hover:border-white/30 hover:text-white/70 transition-all"
                  >
                    ← Back to Login
                  </button>
                </div>
              ...
              <p className="mt-5 text-center text-[10px] text-white/30 font-medium uppercase tracking-widest">
